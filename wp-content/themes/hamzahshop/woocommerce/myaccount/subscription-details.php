...
<table class="shop_table subscription_details">
	<tbody>
		...
		$dates_to_display = apply_filters( 'wcs_subscription_details_table_dates_to_display', array(
			'start_date'              => _x( 'Date de début', 'customer subscription table header', 'woocommerce-subscriptions' ),
			'last_order_date_created' => _x( 'Date de la dernière commande', 'customer subscription table header', 'woocommerce-subscriptions' ),
			'next_payment'            => _x( 'Prochaine date de paiement', 'customer subscription table header', 'woocommerce-subscriptions' ),
			'end'                     => _x( 'Date de fin', 'customer subscription table header', 'woocommerce-subscriptions' ),
			'trial_end'               => _x( 'Date de fin de l\'essai', 'customer subscription table header', 'woocommerce-subscriptions' ),
		), $subscription );
