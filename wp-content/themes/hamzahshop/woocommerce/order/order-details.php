...
<script type="text/javascript">
    $(window).on('load',function(){
       <?php 
	   if ( $show_downloads ) {
	   echo "$('#download-modal').modal('show');";
	   }?>
    });
</script>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title" >Nous vous remercions de votre commande</h3>
		<h4 class="modal-title" >Veuillez cliquer sur les boutons pour télécharger vos produits</h4>
      </div>
