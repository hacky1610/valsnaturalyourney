...
class UiElements
{
    ...
    public function getCourseOverViewUri()
    {
        return $this->siteUri . "/mon-compte/members-area";
    }

    public function vnj_checkout_register()
    {?>
    ...
    public function getCart($woocommerCart)
    {
        ?>
...
$count = esc_attr($woocommerCart->get_cart_contents_count());
    ...
    public function ShowShakeComment($cartArray)
    {
    ...
    public function CreateCourseButton($userStartDate, $postId, $name, $days, $dateCurrent = null)
    {
