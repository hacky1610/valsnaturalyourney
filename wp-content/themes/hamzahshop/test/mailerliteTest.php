...
class MailerliteTest extends TestCase
{
    ...
    public function testMoveToAllGroup_addOneSubscriber()
    {
    ...
    public function testMoveToAllGroup_addTwoSubscriber()
    {
    ...
    public function testMoveToAllGroup_subscriberExist()
    {
